...
(function($){
	$.lang = {
		...
		default_evaluation_form_fields: [
			{title:"\u611f\u8c22\u60a8\u7684\u652f\u6301\uff0c\u8bf7\u5bf9\u6211\u7684\u670d\u52a1\u8fdb\u884c\u8bc4\u4ef7",name:"evaluation",type:"radio",required:true,defaultText:"5",options:[
				{text:"\u975e\u5e38\u6ee1\u610f",value:"5"},
				{text:"\u6ee1\u610f",value:"4"},
				{text:"\u4e00\u822c",value:"3"},
				{text:"\u4e0d\u6ee1\u610f",value:"2"},
			...
			{title:"\u5efa\u8bae", multipart: true,name:"proposal",type:"textarea","defaultText":"\u611f\u8c22\u60a8\u7684\u53cd\u9988\uff0c\u6211\u4eec\u4f1a\u66f4\u52a0\u52aa\u529b\u3002",required:false,max:200,message:["","","\u5efa\u8bae\u5185\u5bb9\u4e0d\u80fd\u8d85\u8fc7100\u4e2a\u4e2d\u6587\u5b57\u7b26"]}
		],
